...
const TIP_RULES: TipRule[] = [
  ...
  { stat: "accuracyHead", comparator: "lt", threshold: 0.2 },
  { stat: "accuracyEnemySpotted", comparator: "lt", threshold: 0.18 },
  { stat: "sprayAccuracy", comparator: "lt", threshold: 0.2 },
  { stat: "counterStrafingRatio", comparator: "lt", threshold: 0.5 },
  ...
  { stat: "flashLeadingToKill", comparator: "lt", threshold: 0.1 },
  { stat: "heFoesDamageAvg", comparator: "lt", threshold: 10 },
  { stat: "utilityOnDeathAvg", comparator: "gt", threshold: 1 },
